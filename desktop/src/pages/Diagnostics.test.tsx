...
// The "local AI assistant card" describe block below exercises what the
// card renders once past the compile-time feature gate - a companion,
// unmocked test proves the card is hidden entirely against the real flag
// in Diagnostics.featureGate.test.tsx.
